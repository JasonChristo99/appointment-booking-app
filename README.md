...
Ο υπολογισμός των στατιστικών πραγματοποιείται όταν ο υπάλληλος δίνει στο σύστημα εντολή υπολογισμού με παραμέτρους τον τύπο στατιστικού και την χρονική περίοδο προς εξέταση και προκύπτει από ιχνηλάτηση των δεδομένων που υπάρχουν για τα ολοκληρωμένα ραντεβού (στη βάση δεδομένων). Τα στατιστικά έχουν να κάνουν με την ικανοποίηση των πελατών, τον μέσο χρόνο εξυπηρέτησης, το είδος και τον αριθμό των οχημάτων που προσέρχονται στην επιχείρηση, αλλά και οικονομικά στοιχεία, όπως τα μηνιαία έσοδα.
