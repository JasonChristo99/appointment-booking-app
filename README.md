...
Ο υπάλληλος υποδοχής έχει πρόσβαση σε διάφορα στατιστικά στοιχεία που το σύστημα υπολογίζει ανα ημέρα. Τα στοιχεία αυτά έχουν να κάνουν με την ικανοποίηση των πελατών, τον μέσο χρόνο εξυπηρέτησης, το είδος και τον αριθμό των οχημάτων που προσέρχονται στην επιχείρηση, αλλά και οικονομικά στοιχεία όπως το πότε υπάρχει αύξηση πελατείας, και πότε μείωση, αλλά και τα μηνιαία έσοδα. Τα στατιστικά αυτά προκύπτουν από ιχνηλάτηση των δεδομένων που υπάρχουν για τα ολοκληρωμένα ραντεβού όταν κλείνει το ταμίο κάθε μέρα.

#### ΠΧ6 Ολοκλήρωση καθαρισμού
Actor: Καθαριστής
